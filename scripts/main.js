...
function readQuote() {
    db.collection("quotes").doc("tuesday")                                                      //name of the collection and documents should matach excatly with what you have in Firestore
        .onSnapshot(tuesdayDoc => {                                                               //arrow notation
            ...
            document.getElementById("quote_goes_here").innerHTML = tuesdayDoc.data().Quote;      //using javascript to display the data on the right place
    ...
    db.collection(collection).get()
        .then(snap => {
            ...
            snap.forEach(doc => { //iterate thru each doc
                ...
                newcard.querySelector('.card-image').src = `./images/${hikeID}.jpeg`; //Example: NV01.jpg
